...
> MediaVault 8: Local media library manager with transcoding and metadata support
...
## 🧰 Tech Stack
Java, Spring Boot, MySQL, JPA/Hibernate, Docker
...
git clone https://github.com/elitsuri/mediavault-8
cd mediavault-8
